...
RCT_EXPORT_METHOD(openWXMiniApp:(NSDictionary *)data :(RCTResponseSenderBlock)callback)
{
    WXLaunchMiniProgramReq *launchMiniProgramReq = [WXLaunchMiniProgramReq object];
    launchMiniProgramReq.userName = data[RCTWXMiniProgramUsername]; //拉起的小程序的username
        launchMiniProgramReq.path = data[RCTWXMiniProgramPath];    //拉起小程序页面的可带参路径，不填默认拉起小程序首页
    launchMiniProgramReq.miniProgramType = data[RCTWXMiniProgramType]; //拉起小程序的类型
    launchMiniProgramReq.extMsg = data[RCTWXMiniProgramExtMsg];
